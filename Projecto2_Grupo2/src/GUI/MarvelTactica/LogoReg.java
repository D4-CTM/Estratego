...
public class LogoReg extends JFrame implements ActionListener{
    ...
    JTextField Username;
    JLabel Name;
    JButton LogIn, Register, Cancel, change, concretar, regresar, BTNReveal;;
    JFrame Canvas;
    int gamble;
    ...
    private void Canva(){
        ...
        Canvas.setIconImage(new javax.swing.ImageIcon(getClass().getResource("Icon.png")).getImage());
